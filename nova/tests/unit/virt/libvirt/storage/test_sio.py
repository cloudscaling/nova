...
class VolumeNotFound(BaseException):
    pass


class VolumeNotMapped(BaseException):
    pass


class VolumeAlreadyMapped(BaseException):
    pass
...
class SioTestCase(test.NoDBTestCase):
    ...
    def test_remove_volume_with_error(self, mock_siolib):
        self.ioctx.delete_volume.side_effect = BaseException
        self.assertRaises(BaseException, self.driver.remove_volume,
                          self.vol_id)

        mock_siolib.VolumeNotFound = VolumeNotFound
    ...
    def test_map_volume_with_error(self, mock_siolib):
        ...
        self.ioctx.attach_volume.side_effect = BaseException
        self.assertRaises(BaseException, self.driver.map_volume, self.vol_id)

        mock_siolib.VolumeAlreadyMapped = VolumeAlreadyMapped
    ...
    def test_unmap_volume_with_error(self, mock_siolib):
        self.ioctx.detach_volume.side_effect = BaseException
        self.assertRaises(BaseException, self.driver.unmap_volume, self.vol_id)

        mock_siolib.VolumeNotMapped = VolumeNotMapped
    ...
    def test_get_volume_id_with_error(self, mock_siolib):
        ...
        self.ioctx.get_volumeid.side_effect = BaseException
        self.assertRaises(BaseException, self.driver.get_volume_id,
                          self.vol_name)
